...
const Image1 = require('../../assets/section1.png')
const ModalCancel = require('../../assets/modalCancel.png')

export default class FrameAPart1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fontSizeIncrement: 0,
      ...
      <React.Fragment>
        ...
        <ScrollView style={styles.Body} stickyHeaderIndices={[1]}>
          <View style={styles.ContentHeadingCover}>
            <Text style={[
              styles.ContentHeading, { fontSize: (WindowWidth / 21) + this.state.fontSizeIncrement }]}>{data.FrameASection1.Head}
            </Text>
          </View>
          ...
          <View style={styles.BodyContentWrapper}>
            {
              data.FrameASection1.HowToFill.map((section, index) => {
                return (
