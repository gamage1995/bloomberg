...
const Image1 = require('../../assets/FrameBPart5.png')
const ModalCancel = require('../../assets/modalCancel.png')

export default class FrameBPart5 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fontSizeIncrement: 0,
        ...
        <ScrollView style={styles.ModalCover}>
          <View style={styles.Image1Cover}>
            <ImageZoom
              ...
              imageHeight={(WindowWidth - (2 * WindowWidth / 60)) * 0.15}
            >
      ...
      <React.Fragment>
        ...
        <ScrollView style={styles.Body} stickyHeaderIndices={[1]}>
          <View style={styles.ContentHeadingCover}>
            <Text style={[
              styles.ContentHeading, { fontSize: (WindowWidth / 21) + this.state.fontSizeIncrement }]}>{data.FrameB.sections[4]}
            </Text>
          </View>
          ...
          <View style={styles.BodyContentWrapper}>
            {
              data.FrameBPart4.data.map((section, index) => {
                return (
...
const styles = StyleSheet.create({
  ...
  Image1: {
    ...
    height: (WindowWidth - (2 * WindowWidth / 60)) * 0.15,
    alignSelf: 'center'
  },
  CancelButtonCover: {
    position: 'absolute',
