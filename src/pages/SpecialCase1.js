...
const Image1 = require('../../assets/specialCase1.png')
const ModalCancel = require('../../assets/modalCancel.png')
const Arrow = require('../../assets/EventArrow.png');
export default class SpecialCase1 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fontSizeIncrement: 0,
      ...
      <ScrollView style={styles.Body} showsVerticalScrollIndicator={false}>
        <View style={styles.ContentBodyCover}>
          <Text style={[
            ...
            }]}>{data.SpecialCases[0].CaseDescription}</Text>
        </View>
    ...
    return (
      <ScrollView style={styles.Body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.SectionsWrapper}>
          {
            data.SpecialCases[0].CaseApplication.Events.map((event, index) => {
