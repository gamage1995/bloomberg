...
const Image1 = require('../../assets/specialCase5.png')
const ModalCancel = require('../../assets/modalCancel.png')
const Arrow = require('../../assets/EventArrow.png');
export default class SpecialCase5 extends Component {
  constructor(props) {
    super(props);
    this.state = {
      fontSizeIncrement: 0,
        ...
        <ScrollView style={styles.ModalCover}>
          <View style={styles.Image1Cover}>
            <ImageZoom
              ...
              imageHeight={(WindowWidth - (2 * WindowWidth / 60)) * 0.64}
            >
      ...
      <ScrollView style={styles.Body} showsVerticalScrollIndicator={false}>
        <View style={styles.ContentBodyCover}>
          <Text style={[
            ...
            }]}>{data.SpecialCases[4].CaseDescription}</Text>
        </View>
        ...
        <View style={styles.ContentBodyCover}>
          <Text style={[
            styles.ContentBodyText,
            {
              fontSize: (WindowWidth / 21) + this.state.fontSizeIncrement,
              lineHeight: (WindowWidth / 21) + this.state.fontSizeIncrement + 8
            }]}>{data.SpecialCases[4].CaseExample}</Text>
        </View>
        <View style={styles.BottomPadding}>
    ...
    return (
      <ScrollView style={styles.Body} showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.SectionsWrapper}>
          {
            data.SpecialCases[4].CaseApplication.Events.map((event, index) => {
    ...
    return (
      <React.Fragment>
        ...
        <Header
          ...
          heading={data.SpecialCases[4].Title.toUpperCase()}
...
const styles = StyleSheet.create({
  ...
  Image1: {
    ...
    height: (WindowWidth - (2 * WindowWidth / 60)) * 0.64,
    alignSelf: 'center'
  },
  CancelButtonCover: {
    position: 'absolute',
